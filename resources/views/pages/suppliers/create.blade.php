...
<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 ">
  ...
  <div class="space-y-12">
    <div class="border-b border-gray-900/10 pb-12">
      ...
      <h2 class="text-base font-semibold leading-7 text-gray-900">Add New Supplier</h2>
      <p class="mt-1 text-sm leading-6 text-gray-600">only admin can add new supplier</p>
      ...
      <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        ...
        <div class="sm:col-span-full">
            ...
            <div class="relative mt-2 rounded-md shadow-sm">
                ...
                <input required type="number" name="contact" id="contact" class="block w-full rounded-md border-0 py-1.5 pl-7 pr-12 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
        ...
        <div class="sm:col-span-full">
          ...
          <div class="mt-2">
          <textarea required id="address" name="address" rows="3" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></textarea>
          </div>
        </div>
      </div>
