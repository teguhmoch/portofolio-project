...
<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 ">
  ...
  <div class="mx-auto max-w-3xl ">
    ...
    <div class="my-5">
    <form method="POST" action="{{ route('product-out.store') }}">
            @csrf
  <div class="space-y-12">
    <div class="border-b border-gray-900/10 pb-12">
      ...
      <h2 class="text-base font-semibold leading-7 text-gray-900">Add New Product Out</h2>
      <p class="mt-1 text-sm leading-6 text-gray-600">only admin can add new product out</p>
