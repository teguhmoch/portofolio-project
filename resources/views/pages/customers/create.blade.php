...
<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 ">
  ...
  <div class="space-y-12">
    <div class="border-b border-gray-900/10 pb-12">
      ...
      <h2 class="text-base font-semibold leading-7 text-gray-900">Add new customer</h2>
      <p class="mt-1 text-sm leading-6 text-gray-600">only admin can add new customer</p>
      ...
      <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
       ...
       <div class="sm:col-span-full">
        ...
        <div class="sm:col-span-full">
          <label for="nik" class="block text-sm font-medium leading-6 text-gray-900">Address</label>
          <div class="mt-2">
            <input required id="address" name="address" type="text" autocomplete="address" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
          </div>
        </div>
