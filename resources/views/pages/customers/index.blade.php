...
@if (session('error'))
            ...
            <div class="border-b border-gray-900/10 mb-4 pb-4">
                <nav class="w-full rounded-md">
                    <ol class="list-reset flex">
                        ...
                        <li>
                            <span class="text-sm text-neutral-500">Customer</span>
                        </li>
                    </ol>
                </nav>
                <div class="mt-2">
            ...
            <table id="example" class="stripe hover" style="width:100%; padding-top: 1em; padding-bottom: 1em;">
                ...
                <tbody>
                    ...
                    <tr class="text-black">
                        ...
                        <button onClick="showUrl({{ $customer->id }})" class="mb-1 bg-cyan-500 hover:bg-cyan-600 text-grey-darkest font-bold py-2 px-4 rounded inline-flex items-center">
                            ...
                            <button onClick="editUrl({{ $customer->id }})" class="mb-1 bg-yellow-500 hover:bg-yellow-600 text-grey-darkest font-bold py-2 px-4 rounded inline-flex items-center">
                            ...
                            @if($isMaster != null)
                            <button onClick="deleteUrl({{ $customer->id }})" class="bg-red-500 hover:bg-red-600 text-grey-darkest font-bold py-2 px-4 rounded inline-flex items-center">
    ...
    <script>
        function showUrl(id) {
            var productId = id;
            var url = "customer/show/" + productId;
            window.location.href = url;            
        }
        function editUrl(id) {
            var productId = id;
            var url = "customer/edit/" + productId;
            window.location.href = url;            
        }
        function deleteUrl(id) {
            var productId = id;
            var url = "customer/destroy/" + productId;
            window.location.href = url;            
        }
    </script>
